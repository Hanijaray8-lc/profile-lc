...
const UnewUser = () => {
  ...
  const validateForm = () => {
    ...
    if (!form.email.endsWith("@gmail.com")) {
      alert("Email must be a valid Gmail address (end with @gmail.com).");
      return false;
    }
    return true;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://profile-lc.onrender.com/api/users", form);
      alert("User created successfully!");
      // Save new user to localStorage for Profile page
